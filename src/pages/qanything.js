  ...
  return (
    <Layout title="QAnything问答服务">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-heading-color mb-2">QAnything问答服务</h1>
        ...
        <div className="card mb-8">
          <div className="flex items-start mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-heading-color">关于QAnything集成</h2>
        ...
        <div className="card">
          <h2 className="text-xl font-bold text-heading-color mb-4">问答演示</h2>
